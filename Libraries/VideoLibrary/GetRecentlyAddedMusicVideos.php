...
namespace MMC\XBMCBundle\API\XBMC\Libraries\VideoLibrary;

use \MMC\XBMCBundle\API\XBMC\Libraries\APIMethod as APIMethod;

/**
 * A simple definition for VideoLibrary.GetRecentlyAddedMusicVideos
 ...
 *
 */
class GetRecentlyAddedMusicVideos extends APIMethod
{
}