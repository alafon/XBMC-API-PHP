...
namespace MMC\XBMCBundle\API\XBMC\Libraries\AudioLibrary;

use \MMC\XBMCBundle\API\XBMC\Libraries\APIMethod as APIMethod;

/**
 * A simple definition for AudioLibrary.GetRecentlyAddedAlbums
 ...
 *
 */
class GetRecentlyAddedAlbums extends APIMethod
{
}